...
{
    public class GithubRoutesBenchmark : LinkGenerationBenchmarkBase
    {
        private LinkGenerator _linkGenerator;
        private TreeRouter _treeRouter;
        private RequestContext _requestContext;
        private RouteValueDictionary _lookUpValues;
        private MatcherEndpoint[] _endpoints;

        [GlobalSetup]
        public void Setup()
        {
            _endpoints = GetGithubEndpoints();
            var services = CreateServices(_endpoints);
            ...
            var endpointToTest = _endpoints[176];
